...
public class Pipe {
    // http://pipe-collect.ebu.io/v1/pipeconfig GET a appeler une fois au boot de l'appli si sur
    // false = ne collecte pas dans un premier temps a voir pour une queue de calls
